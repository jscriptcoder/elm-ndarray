	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('File Reader library example'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Use the file dialog to load file'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Main$OnFileContent = function (a) {
	return {ctor: 'OnFileContent', _0: a};
};
var _user$project$Main$getFileContents = function (nf) {
	return A2(
		_elm_lang$core$Task$attempt,
